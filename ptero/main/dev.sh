...
while true; do
    ...
    read -r opt
    case $opt in
        1) bash <(curl -s https://raw.githubusercontent.com/ArainCloud07/ptero/refs/heads/main/ptero/vps/run.sh) ;;
        2) bash <(curl -s https://raw.githubusercontent.com/ArainCloud07/ptero/refs/heads/main/ptero/panel/run.sh) ;;
        ...
        8|exit) 
            echo -e "\n  ${B_RED}DISCONNECTED.${NC} Goodbye, Shubham."
            exit 0 ;;
        *) 
